...
namespace qmapcontrol
{
    ...
    void LayerManager::removeLayer(qint32 layerNumber)
    {
        Layer *layer;
        layer = mylayers.at(layerNumber);
        disconnect(layer, SIGNAL(updateRequest(QRectF)),
                this, SLOT(updateRequest(QRectF)));
        disconnect(layer, SIGNAL(updateRequest()),
                this, SLOT(updateRequest()));

        mylayers.removeAt(layerNumber);
        //delete layer;
    }
