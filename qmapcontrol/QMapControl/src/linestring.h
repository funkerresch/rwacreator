...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        LineString ( QList<QmapPoint*> const points, QString name = QString(), QPen* pen = 0 );
        virtual ~LineString();
