...
namespace qmapcontrol
{
    ...
    LineString::LineString(QList<QmapPoint*> const points, QString name, QPen* pen)
        :Curve(name)
    {
        mypen = pen;
        LineString();
    ...
    void LineString::addPoint(QmapPoint* point)
    {
        vertices.append(point);
    }

    QList<QmapPoint*> LineString::points()
    {
        return vertices;
    }

    void LineString::setPoints(QList<QmapPoint*> points)
    {
    ...
    bool LineString::Touches(QmapPoint* geom, const MapAdapter* mapadapter)
    {
